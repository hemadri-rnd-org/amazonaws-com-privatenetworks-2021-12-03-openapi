# AWS Private 5G MCP Server

This MCP (Model Content Protocol) server provides access to AWS Private 5G API functionality through HTTP, HTTPS, and STDIO transport modes.
