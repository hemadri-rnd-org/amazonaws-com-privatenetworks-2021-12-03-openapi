...
func ListnetworksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/networks/list%s", cfg.BaseURL, queryString)
		...
		var result models.ListNetworksResponse
...
func CreateListnetworksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_networks_list",
		mcp.WithDescription("Lists networks. Add filters to your request to return a more specific list of results. Use filters to match the status of the network."),
