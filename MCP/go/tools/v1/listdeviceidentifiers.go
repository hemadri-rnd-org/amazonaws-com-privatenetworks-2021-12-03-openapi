...
func ListdeviceidentifiersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/device-identifiers/list%s", cfg.BaseURL, queryString)
		...
		var result models.ListDeviceIdentifiersResponse
...
func CreateListdeviceidentifiersTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListdeviceidentifiersHandler(cfg),
	}
}
