...
func ListnetworksitesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/network-sites/list%s", cfg.BaseURL, queryString)
		...
		var result models.ListNetworkSitesResponse
...
func CreateListnetworksitesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_network-sites_list",
		mcp.WithDescription("Lists network sites. Add filters to your request to return a more specific list of results. Use filters to match the status of the network site."),
