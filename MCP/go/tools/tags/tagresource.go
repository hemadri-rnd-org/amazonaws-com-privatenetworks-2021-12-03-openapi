...
func CreateTagresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_tags_resourceArn",
		mcp.WithDescription(" Adds tags to the specified resource. "),
		mcp.WithString("resourceArn", mcp.Required(), mcp.Description(" The Amazon Resource Name (ARN) of the resource. ")),
		mcp.WithObject("tags", mcp.Required(), mcp.Description("Input parameter: The tags to add to the resource.")),
	)
